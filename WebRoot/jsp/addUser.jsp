            ...
            <div class="col-md-12">
                <form class="form-horizontal" action="<%=path%>/jsp/doAddUser.jsp" method="post" name="myForm" onsubmit="return test()">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control " name="username" class="form-control" placeholder="用户名">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="password" class="form-control" placeholder="密码">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" class="form-control" placeholder="密码">
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" class="form-control" name="fullname" placeholder="全名">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" class="form-control" name="email" placeholder="邮箱">
                    </div>
                    <div class="form-group">

...
%>
<form
	action="<%=request.getContextPath()%>/jsp/frontend/comment/doAddComment.jsp"
	method="post" name="form1">
	<input type="hidden" name="issueId" value="<%=issueRB.getId()%>" />
	<input type="hidden" name="issueKey"
		value="<%=issueRB.getIssueKey()%>" />
	<%
		...
		<tr>
			...
			<td>
				...
				<input type="button" value="取消"
					onclick="location.href='<c:url value="/jsp/frontend/issue/issueDetailLayout.jsp"/>?issueKey=<%=issueKeyCommnt%>'" />
			</td>
		</tr>
	</table>
	<%

...
<html>
	<body>
		<%
			...
			Comment comment = commentBO.getComment(id);
		%>
		<style>
		   td#TopMenu
				{
			...
			<tbody>
				<tr>
					<td bgcolor="#f0f0f0" width="200" valign="top">
						...
						<img height="1" border="0" width="200" alt=""
								...
								<tr>
									<td>
										<form
											...
											name="simpleform" method="post" action="doDeleteComment.jsp">
												...
												<tbody>
													...
													<tr>
														<td class="fullyCentered simpleformfooter" colspan="2">
															<input id="删除" class="spaced" type="submit"
																title="按 Alt+S 提交" accesskey="S" value="删除" name="删除" />
															<input id="cancelButton" type="button"
																onclick="window.history.back();" value="取消"
																name="/browse/DFD-6" title="取消 (Alt + `)" accesskey="`" />
														</td>
													</tr>
												</tbody>
											</table>

                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table border="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="1%">1.</td>
                                                <td nowrap="">
                                                    <a href="MoveIssue!default.jsp?issueKey=<%=newIssue.getIssueKey()%>" id="move_issue" onclick='window.history.back();'>选择项目和问题类型</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td />
                                    ...
                                    <p>
                                    <table cellspacing="0" cellpadding="1" border="0" bgcolor="#bbbbbb" width="80%">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <table cellspacing="0" cellpadding="4" border="0" bgcolor="#666666" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td bgcolor="#fffff0">
                                                                    <b>注意:</b>
                ...
                <td bgcolor="#ffffff" valign="top">
                    <table cellspacing="0" cellpadding="10" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <form onsubmit="if (this.submitted) return false; this.submitted = true; return true" name="simpleform" method="post" action="MoveIssueConfirm.jsp">
                                        <table class="simpleform maxWidth">
                                            <tbody>
                                                <tr>
                                                    <td class="simpleformheader" colspan="2">
                                                        <h3 class="formtitle">移动问题: 确认</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="simpleformheader" colspan="2">
                                                ...
                                                <tr>
                                                    <td bgcolor="#ffffff" colspan="2">
                                                        <br />
                                                        <table id="move_confirm_table" class="gridTabBox" cellspacing="1" cellpadding="3" align="center" width="95%">
                                                            <tbody>
                                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="fullyCentered simpleformfooter" colspan="2">
                                                        <input id="移动" class="spaced" type="submit" title="按 Alt+S 提交" accesskey="S" value="移动" name="移动" />
                                                        <input id="cancelButton" type="button" onclick="location.href='<c:url value="/jsp/frontend/issue/issueDetailLayout.jsp"/>?issueKey=<%=newIssue.getIssueKey()%>'" value="取消" name="/browse/TT-1" title="取消 (Alt + `)" accesskey="`" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

...
%>
<table cellspacing="0" cellpadding="0" border="0" bgcolor="#dddddd" align="center" width="100%">
    <tr>
        <td>
            <table id="filterFormHeader" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                <tr>
                    <td>过滤器:</td>
                    <td width='1%'>
                        <a class='item' accesskey='V' title='在你当前的搜索/过滤器中查看问题' href='issueNavigator.jsp?mode=hide'>查看</a>
                    </td>
                    <%
                    ...
                    %>
                    <td width='1%'>
                        <a class='item' accesskey='V' title='在你当前的搜索/过滤器中查看问题' href='issueNavigator.jsp?mode=show'>编辑</a>
                    </td>
                    <%
                        } //endif
                    %>
                    <td width='1%'>
                        <a class='item' accesskey='V' title='在你当前的搜索/过滤器中查看问题' href='issueNavigator.jsp?mode=show&createNew=true'>新建</a>
                    </td>
                    <td width='1%'>
                        <a class='item' accesskey='V' title='在你当前的搜索/过滤器中查看问题' href='ManageFilters.jsp'>管理</a>
                    </td>
                </tr>
            </table>
        </td>

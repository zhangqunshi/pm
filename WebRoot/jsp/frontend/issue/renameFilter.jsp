			...
			<tr>
				...
				<td width=80%>
					<form
						...
						name="simpleform" method="post" action="doRenameFilter.jsp">
							...
							<tbody>
								...
								<tr>
									<td class="simpleformheader" colspan="2">
										使用给定的名字和描述保存当前的过滤器.
										<p>
											如果你不确定你当前的过滤器是那个, 你可以通过左边的导航栏查看他的概要.
										</p>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="fieldValueArea" bgcolor="#ffffff">
										<input type="text" size="30" name="filterName"
											value="<%=savedFilter.getFilterName()%>" />
									</td>
								</tr>
								<tr>
									<td class="fieldLabelArea">
									...
									<td class="fieldValueArea" bgcolor="#ffffff">
										<textarea style="width: 90%;" wrap="virtual" rows="3"
											cols="40" name="description"
											><%= savedFilter.getDescription() %></textarea>
									</td>
								</tr>
								...
								<tr>
									<td class="fullyCentered simpleformfooter" colspan="2">
										<input id="保存" class="spaced" type="submit" title="按 Alt+S 提交"
											accesskey="S" value="保存" name="保存" />
										<input id="cancelButton" type="button"
											onclick="location.href='issueNavigator.jsp?mode=hide'" value="取消"
											name="issueNavigator.jsp" title="取消 (Alt + b)" accesskey="b" />
									</td>
								</tr>
							</tbody>
						</table>

...
<%
	...
	if ("true".equals(createNewRT)) { //如果是新建Filter
		content = "<p>问题导航栏允许你浏览系统内的所有问题. 过滤器允许你过滤你看到的问题.</p>" 
					+ "<p>使用左边的控制板,你可以创建/编辑新的过滤器.</p>"; 
	} else {
			...
			if (issueListInPage == null || issueListInPage.size() == 0) { //如果没有任何问题
				...
				content = "显示<b>" + issueListInPage.size() + "</b>个问题中的 <b>1</b> 到 <b>"
						+ issueListInPage.size() + "</b> ..";
			}
	}
...
<table cellspacing="0" cellpadding="10" class="simpleform maxWidth"
	border="0">
	<tr>

...
<%
	...
	User user = ubo.getUser("username");
	if (issueLT == null) {
...
<table border="0">
	<tr>
		...
		<td valign="top">
			<b><a href="#" id="issue_key_TT-9"><%= issueLT.getIssueKey() %></a> </b>
		</td>
	</tr>
	...
	<tr>
		...
		<td valign="top">
			<img height="16" border="0" align="absmiddle" width="16"
				title="<%= issueLT.getIssueTypeName() %>" alt="<%= issueLT.getIssueTypeName() %>"
				src="<%=request.getContextPath() %><%= issueLT.getIssueTypeIcon() %>" />
	...
	<tr>
		...
		<td valign="top">
			<img height="16" border="0" align="absmiddle" width="16"
				title="<%= issueLT.getIssueStatusName() %>"
				alt="<%= issueLT.getIssueStatusName() %>" src="<%=request.getContextPath() %><%= issueLT.getIssueStatusIcon() %>" />
 ...
 <%
  ...
  %>
	<tr>
		...
		<td valign="top">
			<img height="16" border="0" align="absmiddle" width="16"
				title="<%= issueLT.getPriorityLevel() %>" alt="<%= issueLT.getPriorityLevel() %>"
				src="<%=request.getContextPath() %><%= issueLT.getPriorityLevelIcon() %>" />

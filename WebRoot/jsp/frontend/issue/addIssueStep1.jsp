...
<body>
    <form action="addIssueStep2.jsp" method="post">
        <table border="0">
            ...
            <tr>
                <td colspan="2">步骤1（共2）：选择项目和问题类型</td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    <input type="button" onclick="location.href='<c:url value="/jsp/frontend/dashboard.jsp"/>'" value="取消" title="取消 (Alt + `)" accesskey="`" id="cancelButton" />
                </td>
            </tr>
        </table>
    </form>

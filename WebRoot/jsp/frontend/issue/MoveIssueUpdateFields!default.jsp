...
<%
    ...
    Projecthbm project = projectBo.getProject(pidInt);

    //获得IssueType对象
    IssueTypeBO issueTypeBo = new IssueTypeBO();
    IssueTypehbm issueType = issueTypeBo.getIssueType(issueTypeInt);
%>
</head>
<body>
    <%
                                        ...
                                        <table border="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="1%">1.</td>
                                                    <td nowrap="">
                                                        <a href="MoveIssue!default.jsp?issueKey=<%=issue.getIssueKey()%>" id="move_issue" onclick='window.history.back();'>选择项目和问题类型</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td />
                    ...
                    <td bgcolor="#ffffff" valign="top">
                        <table cellspacing="0" cellpadding="10" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <td>
                                        <form onsubmit="if (this.submitted) return false; this.submitted = true; return true" name="simpleform" method="post" action="MoveIssueUpdateFields.jsp">
                                            <table class="simpleform maxWidth">
                                                <tbody>
                                                    <tr>
                                                        <td class="simpleformheader" colspan="2">
                                                            <h3 class="formtitle">移动问题: 更新字段</h3>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="simpleformheader" colspan="2">

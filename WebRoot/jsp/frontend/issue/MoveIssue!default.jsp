											...
											<table border="0">
												<tbody>
													<tr>
														<td valign="top">
															<img alt=""
																src="<%=request.getContextPath()%>/images/icons/bullet_inprogress.gif" />
														</td>
														<td width="1%">
															<b>1.</b>
														</td>
													...
													<tr>
														<td>
															<img alt=""
																src="<%=request.getContextPath()%>/images/icons/bullet_notdone.gif" />
														</td>
														<td width="1%">
															2.
														</td>
									...
									<tr>
										<td>
											<form
												...
												name="simpleform" method="post" action="MoveIssue.jspa">
												<table class="simpleform maxWidth" border="0"
																					...
																					<table width="100%">
																						<tbody>
																							...
																							<tr>
																								...
																								<td nowrap="" align="absmiddle">
																									<img height="16" border="0" align="absmiddle"
																										width="16"
																										src="<%=request.getContextPath()%>/images/icons/arrow_right_small.gif" />
																								</td>
																								<td nowrap="" align="absmiddle" width="20%">
																									<b>新项目</b> :
																								</td>
																									...
																									<select id="project" name="pid">
																										<%
																											for (int i = 0; i < projectList.size(); i++) {
																												...
																												if (project.getProjectId() == projectMove.getProjectId()) {
																													out.println("<option selected value="
																															+ projectMove.getProjectId() + ">"
																															+ projectMove.getName() + "</option selected>");
																												} else {
																													out.println("<option value=" + projectMove.getProjectId()
																															+ ">" + projectMove.getName() + "</option>");
																												}
																							...
																							<tr>
																								...
																								<td id="issuetype_container">
																									<select id="issuetype" class="imagebacked"
																										name="issuetype">
																										<%
																											for (int i = 0; i < issueTypeList.size(); i++) {
																												...
																												if (issueType.getId() == issueTypeMove.getId()) {
																													out.println("<option selected value="
																															+ issueTypeMove.getId() + ">"
																															+ issueTypeMove.getName() + "</option selected>");
																												} else {
																													out.println("<option value=" + issueTypeMove.getId() + ">"
																															+ issueTypeMove.getName() + "</option>");
																												}
																		...
																		<tr>
																			<td class="fullyCentered simpleformfooter" colspan="2">
																				...
																				<input type='button' value='取消'
																					onclick="location.href='<c:url value="/jsp/frontend/issue/issueDetailLayout.jsp"/>?issueKey=<%=moveIssueKey%>'" />
																			</td>
																		</tr>
																	</tbody>
																</table>

...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td bgcolor="#f0f0f0" valign="top">
			<b><a href="#"><%=issueR.getProjectName()%></a> </b>
			<br />
			<h3 class="formtitle">
				<img height="16" border="0" width="16" alt=""
					src="<%=request.getContextPath()%>/images/icons/link_out_bot.gif" /><%=issueR.getName()%></h3>
			<font size="1"> 创建: <span class="date"><%=issueR.getCreateDate()%></span>
				  更新: <span class="date"><%=issueR.getLastUpdateDate()%></span> 逾期: <font
				color="#336699"><%=issueR.getPlanEndTime()%></font> </font>
		</td>
	</tr>
</table>

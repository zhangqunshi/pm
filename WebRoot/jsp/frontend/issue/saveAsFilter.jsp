...
<body>
    <table border="0" width=100%>
        <tr>
            ...
            <td width=80%>
                <form onsubmit="if (this.submitted) return false; this.submitted = true; return true" name="simpleform" method="post" action="doSaveAsFilter.jsp">
                    <table class="simpleform maxWidth" width=100%>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fieldValueArea" bgcolor="#ffffff">
                                    <textarea style="width: 90%;" wrap="virtual" rows="3" cols="40" name="description"></textarea>
                                </td>
                            </tr>
                            <tr>

        ...
        <tr>
            ...
            <td valign="top" width=80%>
                <table class="simpleform maxWidth" width=100%>
                    <tr>
                        <td class="simpleformheader" colspan="2">
                            <h3 class="formtitle">管理过滤配置</h3>
                        </td>
                    </tr>
                    <tr>
                        <td class="simpleformheader" colspan="2">这是你目前保存的过滤.你可以查看或者删除它们.</td>
                    </tr>
                </table>
                ...
                <table class="simpleform" width="100%" border="1">
                    <tr bgcolor="#f0f0f0">
                        <th class="colHeaderLink" width="50%" height="30">你的过滤器</th>
                        <th class="colHeaderLink" width="50%">操作</th>
                    </tr>

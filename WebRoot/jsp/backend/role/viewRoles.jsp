                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <s:iterator value="#roleList" var="rs">
                            <tr>
                                <td>
                                    <s:property value="#rs.roleName" />
                                </td>
                                <td>
                                    <s:property value="#rs.roleDesc" />
                                </td>
                                <td>
                                    <a href="deleteRole.jsp?id=<s:property value="#rs.roleId"/>">删除</a>
                                    |
                                    <a href="updateRole.jsp?id=<s:property value="#rs.roleId"/>">编辑</a>
                                </td>
                            </tr>
                        </s:iterator>
                    </tbody>

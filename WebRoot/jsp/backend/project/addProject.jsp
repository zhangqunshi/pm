...
.STYLE29 {
	...
	<body>
		...
		<form action="doAddProject.jsp" name="myForm"
			...
			<table border="0" cellspacing="0">
				<tr>
					<td height="65" colspan="2" align="left" valign="middle"
						...
						<br />
						<span class="STYLE28"><br /> <span class="STYLE29">Enter
								your new project details... </span> </span>
					</td>
				</tr>
				...
				<tr>
					...
					<td height="45" valign="top">
						...
						<br />
						<span class="STYLE18 STYLE19 STYLE23">This is the unique
							project key. It specifies the first letters of issue keys in this
							project. &nbsp;</span>
					</td>
				</tr>
				<tr>
					...
					<td height="45" valign="top">
						<label>
							...
							<br />
							<span class="STYLE24">An optional URL associated with this
								project, eg. pointing to project documentation.</span>
						</label>
					</td>
				</tr>
				<script>
				...
				<tr>
					...
					<td valign="top">
						...
						<br />
						<span class="STYLE24">Optional description of this
							particular ptoject.<br /> <span class="STYLE19">You can
								include HTML.but make sure to close all your tags. </span> </span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<br>
						The Permission Scheme determines who has permissions to view or
						change the project.
					</td>
				</tr>
				<tr>

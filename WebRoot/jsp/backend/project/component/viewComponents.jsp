...
<br>
<a
	href="<c:url value='/jsp/backend/project/component/addProjectComponent.jsp'/>?projectId=<%=projectId2%>">Add</a>
a new component
<br>
<%
	...
	if (componentList.size() == 0) {
		...
		List<ProjectComponent> componentList2 = pcbo2
				.getProjectComponentList(id);
		out.println("<table border='0'>");
		for (int i = 0; i < componentList2.size(); i++) {
			ProjectComponent pc = (ProjectComponent) componentList2
					.get(i);
%>
<tr>
	<td>
		<img hspace="0" height="16" border="0" width="16"
			...
			src="<c:url value='/images/icons/component.gif'/>"
			name="assigneeImage" alt="项目模块"
			title="
		<%out.println(pc.getName()); %>-<%out.println(pc.getDescription()); %>
		">
		<%
			out.println("</td><td>" + pc.getName() + "</td><td><b>");
					if (StringUtils.isEmpty(pc.getLeaderId())) {
						out.println(" ");
					} else {

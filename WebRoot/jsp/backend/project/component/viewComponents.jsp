    ...
    <table>
        <s:iterator value="#components" var="component">
            <tr>
                ...
                <td>
                    <a href="/jsp/backend/project/component/deleteProjectComponent.jsp?idd=<s:property value="#component.id" />&id=<s:property value="#project.projectId" />">删除</a>
                    |
                    <a href="/jsp/backend/project/component/updateProjectComponent.jsp?idd=<s:property value="#component.id" />&id=<s:property value="#project.projectId" />">编辑</a>
                </td>
            </tr>
        </s:iterator>
    </table>

...
<div style="border: 1px solid rgb(187, 187, 187); padding: 2px;">
	<table>
		...
		<tr>
			<td colspan="2">
				<p>Confirm that you want to delete this component, and specify
					what is to be done with the issues currently attached to it.</p>
				<p>Deleting this component will not alter any issues, as there
					are 0 issues associated with it.</p>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" align="right"><input type="submit"
				...
				onclick="location.href='<c:url value="/jsp/backend/project/component/doDeleteProjectComponent.jsp"/>?projectId=<%=pid%>&idd=<%=iid%>'"
				value="Delete" id="删除" name="删除" /> <input type="button"
				onclick="location.href='<c:url value="/jsp/backend/project/viewProjectDetail.jsp"/>?projectId=<%=pid%>'"

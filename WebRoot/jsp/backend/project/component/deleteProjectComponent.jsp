    ...
    <table>
        <tr>
            <td colspan="2">
                <h3 class="formtitle">
                    ...
                    ProjectComponenthbm pc = pcbo.getProjectComponent(iid);
        ...
        <tr>
            <td colspan="2" align="right">
                <input type="submit" class="spaced" title="按 Alt+S 提交" accesskey="S" onclick="location.href='<c:url value="/jsp/backend/project/component/doDeleteProjectComponent.jsp"/>?projectId=<%=pid%>&idd=<%=iid%>'" value="Delete" id="删除" name="删除" />
                <input type="button" onclick="location.href='<c:url value="/jsp/backend/project/viewProjectDetail.jsp"/>?projectId=<%=pid%>'" value="取消" title="取消 (Alt + `)" accesskey="`" id="cancelButton" />

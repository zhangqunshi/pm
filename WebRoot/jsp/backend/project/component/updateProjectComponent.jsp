...
<%
    ProjectComponentBO pcbo = new ProjectComponentBO();
			...
			ProjectComponenthbm pc = pcbo.getProjectComponent(idd);
			int id = 0;
...
<body>
    ...
    <form action="doUpdateProjectComponent.jsp" name="myForm" onsubmit="return test();">
        <table border="0" align="left" width="90%">
            ...
            <tr>
                ...
                <td>
                    <textarea style="width: 90%;" warp="virtual" name="description" cols="150" rows="6" value=<%=pc.getDescription()%>></textarea>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input name="lead" id="lead" type="text" value=<%=pc.getLeader()%>>
            ...
            <tr>
                <td align="center" colspan="2">
                    ...
                    <input type="button" onclick="location.href='../viewProjectDetail.jsp?projectId=<%=id%>'" value="取消" />
                </td>
            </tr>
        </table>
    </form>

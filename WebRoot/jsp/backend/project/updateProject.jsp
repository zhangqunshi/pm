...
<%
	...
	Project project = pb.getProject(Integer.parseInt(request.getParameter("projectId")));
%>
...
<body>
	<h3 class="formtitle">
		Edit Project:
		<%=project.getName()%></h3>
	<br /> Use this page to update your project details.
	...
	<form action="doUpdateProject.jsp" name="myForm"
		...
		<table border="0" align="left" width="90%">
			<tr>
				<td align="right"><i> *名称: </i></td>
				<td><input type="text" name="name" size="50"
					value=<%=project.getName()%>></input></td>
			</tr>

			<tr>
				<td align="right">网址:</td>
				<td><input type="text" name="url" size="50"
					value=<%=project.getUrl()%>></input></td>
			</tr>
			<script>
			...
			<tr>
				<td align="right"><i> *项目负责人: </i></td>
				<td><label> <input type="text" id="lead" name="lead"
						size="50" autocomplete="off" value=<%=project.getLeader()%>></input>
			...
			<tr>
				...
				<td><textarea style="width: 90%;" warp="virtual"
						name="description" cols="150" rows="6"
						title=<%=project.getDescription()%>><%=project.getDescription()%></textarea>
				</td>
			</tr>
			<tr>

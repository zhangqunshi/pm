...
<body>
    <%
        ...
        ProjectCategoryhbm category = pc.getProjectCategory(i);
    %>
        ...
        <table border="0">
            ...
            <tr>
                <td colspan="2" align="right">
                    <input type="submit" class="spaced" title="按 Alt+S 提交" accesskey="S" onclick="location.href='<c:url value="/jsp/backend/project/category/doDeleteCategory.jsp"/>?id=<%=i%>'" value="删除" id="删除" name="删除" />

						...
						<form
							...
							<table class="simpleform maxWidth">
								<tbody>
									...
									<tr>
										<td class="simpleformheader" colspan="2">
											This page allows you to select which project category you
											want this project to be in.
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="fullyCentered simpleformfooter" colspan="2">
											<input id="选择" class="spaced" type="submit"
												title="按 Alt+S 提交" accesskey="S" value="选择" name="选择" />

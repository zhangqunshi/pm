...
<body>
    ...
    <form name="simpleform" method="post" action="doUpdatePermissionScheme.jsp" />
    ...
    <table class="simpleform maxWidth">
        <tbody>
            ...
            <tr>
                ...
                <td class="fieldValueArea" bgcolor="#ffffff">
                    <textarea style="width: 90%;" wrap="virtual" rows="3" cols="30" name="description"><%=scheme.getDescription()%></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td class="fullyCentered simpleformfooter" colspan="2">
                    ...
                    <input id="cancelButton" type="button" onclick="location.href='viewPermissionSchemes.jsp'" value="取消" title="取消 (Alt + `)" accesskey="`" />
                </td>
            </tr>
        </tbody>
    </table>

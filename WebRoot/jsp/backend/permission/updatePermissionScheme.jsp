	...
	<table class="simpleform maxWidth">
		<tbody>
			...
			<tr>
				...
				<td class="fieldValueArea" bgcolor="#ffffff"><input type="text"
					value="<%=scheme.getName()%>" size="30" name="name" /></td>
			</tr>
			<tr>
				<td class="fieldLabelArea">描述:</td>
				<td class="fieldValueArea" bgcolor="#ffffff"><textarea
						style="width: 90%;" wrap="virtual" rows="3" cols="30"
						name="description"><%=scheme.getDescription()%></textarea></td>
			</tr>
			<input id="schemeId" type="hidden" value="<%=scheme.getId()%>"
				name="schemeId" />
			<tr>

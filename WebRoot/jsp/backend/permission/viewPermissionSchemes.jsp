...
<body>
	<%
		...
		List<PermissionScheme> schemeList = permissionSchemeBO.getSchemeList();
	%>
		...
		<tbody>
			...
			<tr>
				<td class="simpleformbody">
					<p>Permission Schemes allow you to create a set of permissions
						and apply this set of permissions to any project.</p>
					<p>All permissions within a scheme will apply to all projects
						that are associated with that scheme.</p> The table below shows the
					permission schemes currently configured for this server.
					<p></p>
				</td>
			</tr>
		</tbody>
			...
			<tr>
				<td>
					<table id="permission_schemes" width="100%" cellspacing="1"
						...
						<tbody>
							<tr bgcolor="#f0f0f0">
								<td class="colHeaderLink"><b>名称</b></td>
								<td class="colHeaderLink"><b>项目</b></td>
								<td class="colHeaderLink"><b>操作</b></td>
							</tr>
							<%
 ...
 %>
								...
								<td nowrap="" valign="top" align="left"><a id="0_edit"
									title="Change permissions for this scheme"
							...
							<tr bgcolor="#fffff0">
								...
								<td nowrap="" valign="top" align="left"><a id="10000_edit"
									title="Change permissions for this scheme"
									href="editPermissions.jsp?schemeId=<%=scheme.getId()%>">Permissions</a>
									| <a title="Create a copy of this scheme"
									href="copyPermissionScheme.jsp?schemeId=<%=scheme.getId()%>">Copy</a>
	...
	<table width="100%">
		<tr>
			<td align="center"><a href="addPermissionScheme.jsp">Add
					Permission Scheme</a></td>
		</tr>
	</table>
</html>

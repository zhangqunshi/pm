...
<body>
    ...
    <table width="90%" cellspacing="0" cellpadding="0" border="0" bgcolor="#bbbbbb" align="center">
        <tbody>
            <tr>
                <td>
                    <table id="permission_schemes" width="100%" cellspacing="1" cellpadding="3" border="0">
                        <tbody>
                            <tr bgcolor="#f0f0f0">

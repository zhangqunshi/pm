        ...
        <table class="simpleform maxWidth">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="fieldValueArea" bgcolor="#ffffff">
                        <textarea style="width: 90%;" wrap="virtual" rows="3" cols="30" name="description"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="fullyCentered simpleformfooter" colspan="2">
                        ...
                        <input id="cancelButton" type="button" onclick="location.href='viewPermissionSchemes.jsp'" value="取消" name="cancel" title="取消 (Alt + `)" accesskey="`" />
                    </td>
                </tr>
            </tbody>
        </table>

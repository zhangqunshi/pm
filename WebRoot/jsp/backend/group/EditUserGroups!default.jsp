...
<html>
  ...
  if(StringUtils.isBlank(name)){
   ...
   %>
     <table width="100%" style="border: 1px solid rgb(187,187,187);padding:2px;">
        <tr>
	         <td bgcolor="#f0f0f0" colspan="2">
		         <b>Edit User Groups</b><br>
        ...
        <tr>
            ...
            <a href="<%=request.getContextPath()%>/jsp/backend/user/viewUserDetail.jsp?name=<%=name%>">
            << Return to viewing user '<%=name %>'</a>
            </td>
        </tr>
        <tr>

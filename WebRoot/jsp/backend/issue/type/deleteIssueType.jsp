...
<table>
	...
	<tr>
		<td colspan="2">
			...
			<p>
			    There are currently no matching issues
			</p>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2" align="right">
			<input type="submit" class="spaced" title="按 Alt+S 提交" accesskey="S"
				onclick="location.href='<c:url value="/jsp/backend/issue/type/doDeleteIssueType.jsp"/>?id=<%=id %>'" value="删除" id="删除" name="删除" />
			<input type="button"
				onclick="location.href='<c:url value="/jsp/backend/issue/type/viewIssueType.jsp"/>'" value="取消"

...
<html>
	...
	<tr><th>名称</th><th>描述</th><th>图标</th><th width="100">操作</th></tr>
		<%
			...
			for (int i = 0; i < list.size(); i++) {
				...
				out.println("<td><a href='deleteIssueType.jsp?id=" + issueType.getId() + "' onclick='return confirmDelete();'>删除</a> | <a href='updateIssueType.jsp?id="

			...
			<table border="0">
				<tr>
					...
					<td><input type="text" name="name"
						value="<%=issueType.getName()%>" /></td>
					<td><input type="hidden" name="id" value="<%=id%>" /></td>
				</tr>
				<tr>
					<td align="right">描述：</td>
					<td><input type="text" size="50" name="desc"
						value="<%=issueType.getDescription()%>"></td>
				</tr>
				<script>
				...
				<tr>
					...
					<td><input type="text" id="filename" name="url" size="50"
						value="<%=issueType.getIconUrl()%>" /> [ <a
				...
				<tr>
					<td colspan="2" align="right"><input type="submit" value="更新" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
						onclick="location.href='viewIssueType.jsp'" value="取消" /></td>
				</tr>

	...
	<form action="doAddIssueType.jsp">
		<table border="0">
			...
			<script>
				function openWindow(element) {
					var vWinUsers = window
							.open(
									'_$tag______________________________________________________?element='
											+ element, 'UserPicker',
			...
			<tr>
				...
				<td><input type="text" id="filename" name="iconurl" size="50" />
					[ <a href="javascript:openWindow('filename');">select image</a>]</td>

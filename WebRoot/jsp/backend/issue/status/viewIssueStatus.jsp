...
<html>
	<body>
		...
		<p>
			The table below shows the statuses used
		</p>
		<table border='1' width='100%'>
			...
			<%
				...
				for (int i = 0; i < list.size(); i++) {
					...
					out.println("<a href='updateIssueStatus.jsp?id="
							+ issueStatus.getId() + "' >编辑</a>");
					//如果是系统默认的状态，则不可以删除
					int sid = issueStatus.getId();
					if (sid == Global.OPEN || sid == Global.CLOSE
							|| sid == Global.IN_PROGRESS || sid == Global.REOPEN
							|| sid == Global.RESOLVED) {
						out.println("");
					} else {
						out.println("|<a href='deleteIssueStatus.jsp?id="
								+ issueStatus.getId() + "'>删除</a>");

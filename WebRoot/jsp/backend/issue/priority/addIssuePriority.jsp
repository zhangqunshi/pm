            ...
            <form action="doAddIssuePriority.jsp" class="bs-example bs-example-form" role="form">
                ...
                <script>
                      function openWindow(element) {
                         var vWinUsers = window.open('<c:url value="/jsp/backend/issue/priority/priorityIconPicker.jsp"/>?element='+ element,
                ...
                <script>
                    function openWindowColor(element,defaultColor) {
                             var vWinUsers = window.open('<c:url value="/jsp/backend/issue/priority/colorPicker.jsp"/>?element='

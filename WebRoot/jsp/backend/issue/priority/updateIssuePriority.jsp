						...
						<tbody>
							...
							<tr>
								...
								<td class="fieldValueArea" bgcolor="#ffffff"><input
									type="text" value="<%=issuePriority.getName()%>" size="30"
									name="name" /></td>
							</tr>
							<tr>
								<td class="fieldLabelArea">描述:</td>
								<td class="fieldValueArea" bgcolor="#ffffff"><input
									type="text" value="<%=issuePriority.getDescription()%>"
									size="60" name="desc" /></td>
							</tr>
							<tr>
								<td class="fieldLabelArea"><i> <span title="斜体字是必填的">
											<sup> * </sup> Icon URL
									</span>
								</i> :</td>
								<td class="fieldValueArea" bgcolor="#ffffff"><input
									type="text" value="<%=issuePriority.getIconUrl()%>" size="60"
									name="iconUrl" id="filename" /> <span class="subText">
										[ <a href="javascript:openWindow('filename');">select
											image</a>]
								</span> <br /> <font size="1">(relative to the simple web
										application e.g /images/icons OR starting with http://)</font></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="fullyCentered simpleformfooter" colspan="2"><input
									id="更新" class="spaced" type="submit" title="按 Alt+S 提交"
									accesskey="S" value="更新" name="更新" /> <input id="cancelButton"
									type="button" onclick="location.href='viewIssuePriority.jsp'"
									value="取消" name="ViewPriorities.jspa" title="取消 (Alt + `)"
									accesskey="`" /></td>
							</tr>
						</tbody>
					</table>

...
<html>
	...
	<body>
		...
		<tr><th>名称</th><th>描述</th><th>图标</th><th>颜色</th><th width="100">操作</th></tr>
		<%
			...
			for (int i = 0; i < list.size(); i++) {
				...
				//显示优先级颜色
%>
<td><table><tr><td bgcolor="<%= issuePriority.getPriorityColor() %>"><img height="16" border="0" width="16" alt="" src="<%= request.getContextPath() %>/images/border/spacer.gif"/></td></tr></table></td>
<%
				out.println("<td><a href='deleteIssuePriority.jsp?id="	+ issuePriority.getId()
								+ "' >删除</a> | <a href='updateIssuePriority.jsp?id="
								+ issuePriority.getId() + "' >编辑</a></td></tr>");
			}
		%>
		</table>
